<template>
<div id="outPrint">
    <div class='printFrontPage'>
        <!-- <div class="printBtn">
            <el-button type="primary" @click="onLog" >打印</el-button>
            <el-button type="primary" @click='handleSubmit'>保存</el-button>
        </div> -->
        <div class="medicalRecordOuter">
            <div class="firstTitle">
                <div class="h3">{{ contentInfoTop.orgName }}</div>
                <div class="h4">住院病案首页</div>
                <div class='organizationalCode'>(组织机构代码: {{contentInfoTop.orgCode}})</div>
            </div>
            <div class="baseInfo">
                <div class="baseInfoUp">
                    <div>
                        医疗付费方式: 
                        <span class="dataText">{{contentInfoTop.chargeTypeName}}</span>
                        <!-- <el-select v-model="contentInfoTop.chargeTypeCode" placeholder='' class="minnWidth">
                    ...
                    <div>
                        第
                        <span class="dataText">{{contentInfoTop.visitTimes}}</span>
                        <!-- <el-input v-model="contentInfoTop.visitTimes" placeholder="--" class="inHospitalWidth"
                            @blur='emitVisitTimes'>
                        </el-input> -->
                        次住院
                    </div>
                    <div>
                        病案号
                        <span class="dataText">{{contentInfoTop.visitCode}}</span>
                        <!-- <el-input v-model="contentInfoTop.visitCode" placeholder="--" class="recordNumWidth" /> -->
                    </div>
                </div>
                <div class="baseInfoUp">
                    <div>
                        健康卡号
                        <span class="dataText">{{contentInfoTop.healthCardNo}}</span>
                        <!-- <el-input v-model="contentInfoTop.healthCardNo" placeholder="--" class="cardNumWidth">
                        </el-input> -->
                    </div>
                    <div>
                        识别号(ID)
                        <span class="dataText">{{contentInfoTop.patCode}}</span>
                        <!-- <el-input v-model="contentInfoTop.patCode" placeholder="--" class="IDWidth"></el-input> -->
                    </div>
                </div>
            </div>
            <div class="contentInfo">
                <div class="contentInfoTop">
                    <div>
                        姓名
                        <span class="dataText">{{contentInfoTop.patName}}</span>
                        <!-- <el-input v-model="contentInfoTop.patName" placeholder="--" class="nameWidth"
                            readonly="readonly">
                        </el-input> -->
                    </div>
                    <div>
                        性别
                        <span class="dataText">{{contentInfoTop.sdSex}}</span>
                        <span class="color666">{{sexListStr}}</span>
                        <!-- 注释 -->
                    ...
                    <div>
                        出生日期
                        <span class="dataText">{{contentInfoTop.dtBirth}}</span>
                        <!-- <el-date-picker v-model="contentInfoTop.dtBirth" clearable type="date" placeholder="--"
                    ...
                    <div>
                        年龄
                        <span class="dataText">{{contentInfoTop.ageYear}}</span>
                        <!-- <el-input v-model="contentInfoTop.ageYear" placeholder="--" class="nameWidth"
                            readonly="readonly">
                        </el-input> -->
                    </div>
                    <div class="noThreeBorder">
                        国籍
                        <span class="dataText">{{contentInfoTop.countyName}}</span>
                ...
                <div class="contentInfoTop">
                    <div>
                        <span class="color666">(年龄不足一周岁)</span>年龄
                        <span class="dataText">{{contentInfoTop.ageDay}}</span>
                        <!-- <el-input v-model="contentInfoTop.ageDay" placeholder="--" class="newChildWidth"
                            readonly="readonly"></el-input> -->
                        <span class="color666">月</span>
                    </div>
                    <div>
                        新生儿出生体重
                        <span class="dataText">{{contentInfoTop.weightNbBirth}}</span>
                        <!-- <el-input v-model="contentInfoTop.weightNbBirth" placeholder="--" class="newChildWidth">
                        </el-input> -->
                        <span class="color666">克</span>
                    </div>
                    <div>
                        新生儿入院体重
                        <span class="dataText">{{contentInfoTop.weightNbAdmit}}</span>
                        <!-- <el-input v-model="contentInfoTop.weightNbAdmit" placeholder="--" class="newChildWidth">
                        </el-input> -->
                        <span class="color666">克</span>
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        出生地
                        <span class="dataText">{{contentInfoTop.birthPlace}}</span>
                        <!-- <el-input v-model="contentInfoTop.birthPlace" placeholder="--" class="householdPlaceWidth"
                            readonly="readonly"  @focus="showModal('出生地')"></el-input> -->
                    </div>
                    <div>
                        籍贯
                        <span class="dataText">{{contentInfoTop.nativePlace}}</span>
                        <!-- <el-input v-model="contentInfoTop.nativePlace" placeholder="--" class="householdPlaceWidth"
                            readonly="readonly" @focus="showModal('籍贯')"></el-input> -->
                    </div>
                    <div class="noThreeBorder">
                        民族
                        <span class="dataText">{{contentInfoTop.sdNation}}</span>
                ...
                <div class="contentInfoTop">
                    <div>
                        身份证号
                        <span class="dataText">{{contentInfoTop.idNo}}</span>
                        <!-- <el-input v-model="contentInfoTop.idNo" placeholder="--" class="birthPlaceWidth"></el-input> -->
                    </div>
                    <div class="noThreeBorder">
                        职业
                        <span class="dataText">{{contentInfoTop.occupationName}}</span>
                        <!-- 注释 -->
                    ...
                    <div>
                        婚姻
                        <span class="dataText">{{contentInfoTop.sdMarry}}</span>
                        <span class="color666">{{marryListStr}}</span>
                        <!-- <el-select v-model="contentInfoTop.sdMarry" placeholder="" class="minnWidth">
                ...
                <div class="contentInfoTop">
                    <div>
                        现住址
                        <span class="dataText">{{contentInfoTop.currentPlace}}</span>
                        <!-- <el-input v-model="contentInfoTop.currentPlace" placeholder="--" class="householdPlaceWidth" @focus="showModal('现住址')">
                        </el-input> -->
                    </div>
                    <div>
                        电话
                        <span class="dataText">{{contentInfoTop.currentTel}}</span>
                        <!-- <el-input v-model="contentInfoTop.currentTel" placeholder="--" class="birthDateWidth">
                        </el-input> -->
                    </div>
                    <div>
                        邮编
                        <span class="dataText">{{contentInfoTop.currentZip}}</span>
                        <!-- <el-input v-model="contentInfoTop.currentZip" placeholder="--" class="nameWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        户口地址
                        <span class="dataText">{{contentInfoTop.registPlace}}</span>
                        <!-- <el-input v-model="contentInfoTop.registPlace" placeholder="--" class="householdPlaceWidth" @focus="showModal('户口地址')">
                        </el-input> -->
                    </div>
                    <div>
                        邮编
                        <span class="dataText">{{contentInfoTop.registZip}}</span>
                        <!-- <el-input v-model="contentInfoTop.registZip" placeholder="--" class="nameWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        工作单位及地址
                        <span class="dataText">{{contentInfoTop.workPlace}}</span>
                        <!-- <el-input v-model="contentInfoTop.workPlace" placeholder="--"
                            class="householdPlaceWidth" @focus="showModal('工作单位地址')">
                        </el-input> -->
                    </div>
                    <div>
                        电话
                        <span class="dataText">{{contentInfoTop.workTel}}</span>
                        <!-- <el-input v-model="contentInfoTop.workTel" placeholder="--" class="birthDateWidth"></el-input> -->
                    </div>
                    <div>
                        邮编
                        <span class="dataText">{{contentInfoTop.workZip}}</span>
                        <!-- <el-input v-model="contentInfoTop.workZip" placeholder="--" class="nameWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        联系人姓名
                        <span class="dataText">{{contentInfoTop.contactName}}</span>
                        <!-- <el-input v-model="contentInfoTop.contactName" placeholder="--" class="nameWidth">
                        </el-input> -->
                    </div>
                    <div>
                        关系
                        <span class="dataText">{{contentInfoTop.contactTypeName}}</span>
                        <!-- 注释 -->
                    ...
                    <div>
                        地址
                        <span class="dataText">{{contentInfoTop.contactAddress}}</span>
                        <!-- <el-input v-model="contentInfoTop.contactAddress" placeholder="--"
                            class="householdPlaceWidth" @focus="showModal('联系人地址')">
                        </el-input> -->
                    </div>
                    <div>
                        电话
                        <span class="dataText">{{contentInfoTop.contactTel}}</span>
                        <!-- <el-input v-model="contentInfoTop.contactTel" placeholder="--" class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        入院途径
                        <span class="dataText">{{contentInfoTop.sdAdmitWay}}</span>
                        <!-- <el-select v-model="contentInfoTop.sdAdmitWay" placeholder="" class="minnWidth">
                            <el-option v-for='item in hospitalWayList' :value="item.dataCode" :key='item.dataCode'>
                                {{item.dataCode}}.{{item.dataName}}
                            </el-option>
                        </el-select> -->
                        <span class="color666">{{hospitalWayListStr}}</span>
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        入院日期
                        <span class="dataText">{{contentInfoTop.dtEntry}}</span>
                        <!-- <el-date-picker readonly="readonly" type="datetime" v-model="contentInfoTop.dtEntry"
                    ...
                    <div>
                        入院科别
                        <span class="dataText">{{contentInfoTop.deptAdmitName}}</span>
                        <!-- <el-input v-model="contentInfoTop.deptAdmitName" placeholder="--" class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                    <div>
                        病床
                        <span class="dataText">{{contentInfoTop.stickBedCodeAdmit}}</span>
                        <!-- <el-input v-model="contentInfoTop.stickBedCodeAdmit" placeholder="--" class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                    <div>
                        转科科别
                        <span class="dataText">{{contentInfoTop.strDept}}</span>
                        <!-- <el-input v-model="contentInfoTop.strDept" placeholder="--" class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div>
                        出院日期
                        <span class="dataText">{{contentInfoTop.dtEnd}}</span>
                        <!-- <el-date-picker readonly="readonly" type="datetime" v-model="contentInfoTop.dtEnd"
                            placeholder="--" format='yyyy年MM月dd日 HH时' value-format='yyyy-MM-dd HH:mm:ss'
                            class="inHospitalDateWidth">
                        </el-date-picker> -->
                    </div>
                    <div>
                        出院科别
                        <span class="dataText">{{contentInfoTop.deptDischargeName}}</span>
                        <!-- <el-input v-model="contentInfoTop.deptDischargeName" placeholder="--"
                            class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                    <div>
                        病床
                        <span class="dataText">{{contentInfoTop.stickBedCodeDischarge}}</span>
                        <!-- <el-input v-model="contentInfoTop.stickBedCodeDischarge" placeholder="--"
                            class="birthPlaceWidth">
                        </el-input> -->
                    </div>
                    <div>
                        实际住院
                        <span class="dataText">{{contentInfoTop.actualAdmitDay}}</span>
                        <!-- <el-input v-model="contentInfoTop.actualAdmitDay" placeholder="--" class="birthPlaceWidth">
                        </el-input> -->
                        天
                    </div>
                </div>
                <div class="contentInfoTop">
                    <div class="noThreeBorder">
                        门(急)诊诊断
                        <span class="dataText">{{contentInfoTop.nameDiOut}}</span>
                    ...
                    <div>
                        疾病编码
                        <span class="dataText">{{contentInfoTop.cdDiOut}}</span>
                        <!-- <el-input v-model="contentInfoTop.cdDiOut" placeholder="--" class="nameWidth" readonly>
                        </el-input> -->
                    </div>
                    <div>
                        确诊日期
                        <span class="dataText">{{contentInfoTop.dateDiOut}}</span>
                        <!-- <el-date-picker v-model="contentInfoTop.dateDiOut" type="date" placeholder="--"
                            format='yyyy年MM月dd日' value-format='yyyy-MM-dd HH:mm:ss'
                            :picker-options="dialogPickerOptions" class="birthDateWidth">
                        </el-date-picker> -->
                    </div>
                </div>
                <div class="contentInfoTable" style="margin-top: 5px;">
                    <div class="contentInfoTableMax contentInfoTableTitle">
                        <div>出院诊断</div>
                    </div>
                    <div class="contentInfoTableMid contentInfoTableTitle">
                        <div class="borderBottom">疾病编码</div>
                        <div>M码</div>
                    </div>
                ...
                <div class="contentInfoTable">
                    <div class="contentInfoTableMax transparentBorder contentInfoTableHeight">
                        <div style="white-space:nowrap;">入院病情：<span class="color666">{{dislvlInpStr}}</span></div>
                    </div>
                    ...
                    <div class="contentInfoTableMax transparentBorder contentInfoTableHeight" style="position: relative;">
                        <div style="position:absolute;left:0;white-space:nowrap;">疗效：<span class="color666">{{effectInpStr}}</span></div>
                ...
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight noThreeBorder">
                        损伤、中毒的外部原因
                        <span class="dataText">{{contentInfoTop.reasonHarmPois}}</span>
                    ...
                    <div class="contentInfoTableHeight">
                        疾病编码
                        <span class="dataText">{{contentInfoTop.cdDiHarmPois}}</span>
                        <!-- <el-input v-model="contentInfoTop.cdDiHarmPois" placeholder="--" class="midWidth">
                        </el-input> -->
                    </div>
                </div>
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight noThreeBorder">
                        病理诊断
                        <span class="dataText">{{contentInfoTop.desDiPathgy}}</span>
                    ...
                    <div class="contentInfoTableHeight">
                        疾病编码
                        <span class="dataText">{{contentInfoTop.cdDiPathgy}}</span>
                        <!-- <el-input v-model="contentInfoTop.cdDiPathgy" placeholder="--" class="midWidth"></el-input> -->
                    </div>
                </div>
                <div class="contentInfoTableAcores borderTopNone">
                    ...
                    <div class="contentInfoTableHeight">
                        病理号
                        <span class="dataText">{{contentInfoTop.noPathgy}}</span>
                        <!-- <el-input v-model="contentInfoTop.noPathgy" placeholder="--" class="midWidth"></el-input> -->
                    </div>
                </div>
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight">
                        药物过敏
                        <span class="dataText">{{contentInfoTop.fgAllergy}}</span>
                        <span class="color666">{{drugAllergyOptionStr}}</span>
                        <!-- <el-select v-model="contentInfoTop.fgAllergy" placeholder='' class="minnWidth"
                            @change="changeAllergy">
                            <el-option v-for="item in drugAllergyOptions" :key="item.value" :label="item.label"
                                :value="item.value">
                            </el-option>
                        </el-select>1.无2.有 -->
                        <template v-show="isAllergy">
                            <span class="color666">，过敏药物:</span>
                            <span class="dataText">{{contentInfoTop.desAllergy}}</span>
                        </template>
                    </div>
                    ...
                    <div class="contentInfoTableHeight">
                        死亡患者尸检
                        <span class="dataText">{{contentInfoTop.fgAutopsy}}</span>
                        <span class="color666">{{autopsyOptionStr}}</span>
                ...
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight">
                        血型
                        <span class="dataText">{{contentInfoTop.sdAbo}}</span>
                        <span class="color666">{{bloodTypeStr}}</span>
                        <!-- <el-select v-model="contentInfoTop.sdAbo" placeholder='' class="minnWidth">
                    ...
                    <div class="contentInfoTableHeight">
                        Rh
                        <span class="dataText">{{contentInfoTop.sdRh}}</span>
                        <span class="color666">{{bloodRhStr}}</span>
                    ...
                    <div class="contentInfoTableHeight">
                        抢救
                        <span class="dataText">{{contentInfoTop.rescueNo}}</span>
                        <!-- <el-input v-model="contentInfoTop.rescueNo" placeholder="--" class="minnWidth"></el-input> -->
                        次
                    </div>
                    <div class="contentInfoTableHeight">
                        成功
                        <span class="dataText">{{contentInfoTop.rescueSucNo}}</span>
                        <!-- <el-input v-model="contentInfoTop.rescueSucNo" placeholder="--" class="minnWidth"></el-input> -->
                        次
                    </div>
                </div>
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight noThreeBorder">
                        科主任
                        <span class="dataText">{{contentInfoTop.nameEmpDirector}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        主(副主)任医师
                        <span class="dataText">{{contentInfoTop.nameEmpMajor}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        主治医师
                        <span class="dataText">{{contentInfoTop.nameEmpAdmin}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        住院医师
                        <span class="dataText">{{contentInfoTop.nameEmpIp}}</span>
                ...
                <div class="contentInfoTableAcores borderTopNone">
                    <div class="contentInfoTableHeight noThreeBorder">
                        责任护士
                        <span class="dataText">{{contentInfoTop.nameEmpNur}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        进修医师
                        <span class="dataText">{{contentInfoTop.nameEmpStudy}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        实习医师
                        <span class="dataText">{{contentInfoTop.nameEmpPrac}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        编码员
                        <span class="dataText">{{contentInfoTop.nameEmpCd}}</span>
                ...
                <div class="contentInfoTableAcores">
                    <div class="contentInfoTableHeight">
                        病案质量
                        <span class="dataText">{{contentInfoTop.sdEmrlvl}}</span>
                        <span class="color666">{{qualitymedicalRecordStr}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        质控医师
                        <span class="dataText">{{contentInfoTop.nameEmpPhyQa}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        质控护士
                        <span class="dataText">{{contentInfoTop.nameEmpNurQa}}</span>
                    ...
                    <div class="contentInfoTableHeight noThreeBorder">
                        质控日期
                        <span class="dataText">{{contentInfoTop.dtQa}}</span>
...
<script>
    import LeaveHospDia from './children/printLeaveHospDia.vue';
    ...
    export default {
        data() {
            return {
                ...
                drugAllergyOptionStr: '1.无 2.有',
                autopsyOptionStr: '1.是 2.否',
                bloodTypeStr: '', //血型
                bloodRhStr: '',  //rh
                qualitymedicalRecordStr: '', //病案质量
                dislvlInpStr: '', //入院病情
                effectInpStr: '', //疗效
                drugAllergyOptions: [{
                    value: 1,
        ...
        methods: {
            //打印
            getPrintParams () {
                let coverCss = ".printFrontPage{font-size:12px} .printFrontPage .dataText {line-height: 18px;} .printFrontPage .contentInfoTableHeight {padding-top: 5px;padding-bottom: 5px;line-height: 18px; }.printFrontPage .contentInfoTop {margin-bottom: 5px;}"
                let cssFront = cssom.frontCss(coverCss);
                let domTree = document.getElementById('outPrint').innerHTML;
                return {
                    css: cssFront,
                    dom: domTree
                }
            ...
            initDicInfo() {
                let str = 'SD_CONTACT_TYPE,SD_SEX,SD_MARRY,SD_NATION,SD_ADMIT_WAY,SD_OCCUPATION,SD_BLOOD_TYPE,SD_RH_BLOOD_TYPE,SD_MR_QUALITY,SD_ADMIN_CONDITION,SD_TREATING_RESULT';
                this.findSdData(str).then(data => {
                    ...
                    this.concatBloodList(data.SD_ADMIT_WAY, 'hospitalWayListStr', 'dataCode', 'dataName');
                    this.concatBloodList(data.SD_BLOOD_TYPE, 'bloodTypeStr', 'dataCode', 'dataName');
                    this.concatBloodList(data.SD_RH_BLOOD_TYPE, 'bloodRhStr', 'dataCode', 'dataName');
                    this.concatBloodList(data.SD_MR_QUALITY, 'qualitymedicalRecordStr', 'dataCode', 'dataName');
                    this.concatBloodList(data.SD_ADMIN_CONDITION, 'dislvlInpStr', 'dataCode', 'dataName');
                    this.concatBloodList(data.SD_TREATING_RESULT, 'effectInpStr', 'dataCode', 'dataName');
            ...
            concatSexList(sex) {
                ...
                sexLists.sort((a,b) => {
                    ...
                    this.sexListStr += (item.index + '.' + item.dataName + " ");
                })
            },
            ...
            concatMarryList(marry) {
                ...
                marryLists.sort((a, b) => {
                    ...
                    this.marryListStr += (item.index + '.' + item.dataName + " ");
                }) 
            },
            //拼装 -- 字典 key-排序字段
                ...
                vm.$axios
                    ...
                    .then(res => {
                        if (res.success) {
                            ...
                            vm.$root.Bus.$emit('printIdFrontSheet', res.data.idFrontSheet)
                            if (res.data && vm.idFrontSheet) { //编辑
                                // vm.contentInfoTop = vm.traversalObject(res.data)
                                vm.contentInfoTop = this.objDefaultFormatter(res.data);
                                bus.$emit('medicalRecordAllData', vm.contentInfoTop);
                                vm.changeAllergy(res.data.fgAllergy);  //编辑 --有无过敏史
                                vm.listAssign(vm.contentInfoTop.diagnosisList, res.data.diagnosisList);  //对象赋值
                                vm.$root.Bus.$emit('printDiagnos', vm.contentInfoTop.diagnosisList)
                ...
                vm.$axios
                    ...
                    .then(res => {
                        if (res.success) {
                            ...
                            if (!vm.idFrontSheet) {
                                bus.$emit('PrintpatInfo', res.data)
                                ...
                                vm.contentInfoTop = vm.objDefaultFormatter(vm.contentInfoTop);
                                bus.$emit('medicalRecordAllData', vm.contentInfoTop);
                            }
            ...
            getOutDiaData(idPat) {
                ...
                vm.selectCiDiaRecord(idPat,vm.idVisit, vm.CONSTANT.OUTP_DIAGNOSIS_FLAG ).then(data => {
                     if (data && data.length > 0) {
                        vm.diaDicListsdiagnosisOptions = data
                    } else {
                        this.querySearchDiaByName('').then( data => {
                            this.diagnosisOptions = [];
                            this.diagnosisOptions = data; //诊断列表
                        })
                    }
                })
            },
